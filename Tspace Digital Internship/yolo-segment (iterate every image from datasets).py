...
input_folder = 'D:/Segmentation And Classification/Datasets/0_Bot_Beer_320ML/'

# Define output folder for saving processed images
output_folder = 'D:/Segmentation And Classification/Output/Bot Beer 320'
...
for filename in os.listdir(input_folder):
    if filename.endswith(".png"): # assuming all images are PNG format
        ...
        if results[0].masks is not None:
            ...
            for i, mask in enumerate(results[0].masks): # iterating through each mask
